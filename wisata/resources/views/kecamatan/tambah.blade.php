    ...
    <div class="row">
        <div class="tile col-12 mb-4">
            <div class="page-header">
              <div class="row">
                <div class="col-lg-12">
                  <h2 class="mb-3 line-head" id="buttons">List Wilayah</h2>
                </div>
              </div>
            </div>
            <div class="row">
                <form action="{{ route('kecamatan.store') }}" method="POST" class="col-12">
                    ...
                    <input class="form-control"  type="text"  placeholder="Masukan Nama wilayah, ex: tanah bumbu" name="nama_wilayah">
                  </div>
